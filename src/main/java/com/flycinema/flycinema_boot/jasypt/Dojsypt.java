...
/**
 * @ClassName Dojsypt jyspt加密工具
 * @Author admin
 * @Date 2021/3/30 14:19
 */
public class Dojsypt {
    /**
     ...
     * 3、setConfig(final PBEConfig config)：为对象设置  配置对象
    ...
    /**
     * 设置  配置对象，SimpleStringPBEConfig 是它的实现类
    ...
    public static void main(String[] args) throws Exception {
        String message = "123456";//需要加密的内容
        String password = "ldr"; //密钥
...
//        System.out.println(jasyptEncrypt);
        ...
        String jasyptEncrypt1 = stringEncryptor(password, "30rODF7J0iOgARw9kOjfEQSiMFpSMLO2aZgdGCPes3qYayOlwXcjZD7n4I+/bcVH", false);
